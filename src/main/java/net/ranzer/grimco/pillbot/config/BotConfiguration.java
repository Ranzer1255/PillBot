package net.ranzer.grimco.pillbot.config;
...
public class BotConfiguration {
	...
	private static final String CONFIG_PATH = "/pillBot/config/pillBot.conf";
	...
	private BotConfiguration(){
		...
		String logPath = "/pillBot/logs/pillBot.log";
	...
	@BotConfigItem(key="logLocation", type=String.class, _default="/pillBot/logs/pillBot.log")
